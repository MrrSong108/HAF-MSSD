...
# Single-time-step input format: [num_samples, 1, num_features]
...
# =========================
def build_model(input_shape, lstm_units_1, lstm_units_2, dropout_rate, learning_rate, l2_reg):
    model = Sequential()
...
def objective(trial):
    ...
    # Epochs are not used as a tuning parameter here. EarlyStopping provides more stable control.
    max_epochs = 150
...
print("Best validation RMSE:", study_bilstm.best_value)
print("Best hyperparameters:", study_bilstm.best_params)

best_params = study_bilstm.best_params

with open(OUTPUT_DIR / "best_bilstm_params.json", "w", encoding="utf-8") as f:
