...
save_dir = "/root/autodl-tmp/airport_project/data/xiao/traff/class/lstm"
...
print(f"\n最优Accuracy: {1 - study_lstm_cls.best_value:.4f}")
print("最佳超参数:")
...
# best_params = {'lstm_units_1': 128, 'lstm_units_2': 32, 'dense_units': 32, 'dropout_rate': 0.10132267547092351, 'learning_rate': 0.0006595381199615347, 'l2_reg': 1.782296872960978e-05, 'batch_size': 256, 'patience': 8}


# =========================
# 11. 使用最佳参数训练最终 LSTM 模型
# =========================
K.clear_session()
gc.collect()
