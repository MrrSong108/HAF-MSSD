...
save_dir = "/root/autodl-tmp/airport_project/results/result_classifier/result_bilstm_classifier"
...
# 10. Optuna 调参
# =========================
study_bilstm_cls = optuna.create_study(direction="maximize")
...
print(f"\nOptuna 最优验证集 Balanced Accuracy: {study_bilstm_cls.best_value:.4f}")
print("最佳超参数:")
print(study_bilstm_cls.best_params)

print("\nOptuna 最优 trial 对应阈值:")
print(study_bilstm_cls.best_trial.user_attrs)
...
threshold_info = {
    ...
    "optuna_best_value": float(study_bilstm_cls.best_value),
    "optuna_best_trial_threshold": float(
        study_bilstm_cls.best_trial.user_attrs.get("best_threshold", -1)
    )
}
