...
SAVE_ROOT = Path("/root/autodl-tmp/airport_project/data/xiao/check/cluster/rf")
...
# 建议 Optuna 不并行，避免 50 个 trial 同时启动多个 RF，导致 CPU 线程爆炸
OPTUNA_N_JOBS = 1
...
def main():
    ...
    summary_csv_path = SAVE_ROOT / "rf_all_classes_all_clusters_metrics.csv"
