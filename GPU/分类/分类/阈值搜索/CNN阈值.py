...
save_dir = "/root/autodl-tmp/airport_project/results/result_classifier/result_cnn_classifier"
...
# 10. Optuna 调参
# =========================
study_cnn_cls = optuna.create_study(direction="maximize")
...
print(f"\nOptuna 最优验证集 Balanced Accuracy: {study_cnn_cls.best_value:.4f}")
print("最佳超参数:")
