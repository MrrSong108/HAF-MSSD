...
save_dir = "/root/autodl-tmp/airport_project/data/xiao/traff/class/gru"
...
# 当前沿用单时间步输入形式，与前面的 LSTM/GRU 回归实验保持一致
...
print(f"\n最优Accuracy: {1 - study_gru_cls.best_value:.4f}")
print("最佳超参数:")
