...
OUTPUT_DIR = Path(os.getenv("OUTPUT_DIR", "outputs/lstm_classifier"))
...
print(f"\nBest balanced accuracy: {1 - study_lstm_cls.best_value:.4f}")
...
with open(
    OUTPUT_DIR / "best_lstm_classifier_params.json",
    "w",
    encoding="utf-8",
) as f:
...
# =========================
# 9. Train the final LSTM classifier with the best hyperparameters
# =========================
K.clear_session()
gc.collect()
...
# =========================
best_model.save(OUTPUT_DIR / "lstm_classifier.keras")
