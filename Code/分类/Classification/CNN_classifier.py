...
OUTPUT_DIR = Path(os.getenv("OUTPUT_DIR", "outputs/cnn_classifier"))
...
# =========================
# 5. CNN model construction function
# =========================
def build_model(
    input_shape,
    filters_1,
...
print(f"\nBest balanced accuracy: {1 - study_cnn_cls.best_value:.4f}")
...
with open(
    OUTPUT_DIR / "best_cnn_classifier_params.json",
    "w",
    encoding="utf-8",
) as f:
...
# =========================
# 9. Train the final CNN classifier with the best hyperparameters
# =========================
K.clear_session()
gc.collect()
...
# =========================
best_model.save(OUTPUT_DIR / "cnn_classifier.keras")
