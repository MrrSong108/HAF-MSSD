...
def prepare_train_validation_test(train_df, validation_df, test_df):
    ...
    X_validation_gru = X_validation.reshape(X_validation.shape[0], 1, X_validation.shape[1])
    ...
    return {
        ...
        "X_validation_gru": X_validation_gru,
...
def train_one_cluster(class_name, train_path, validation_path, test_path):
    ...
    X_train_gru = data["X_train_gru"]
    X_validation_gru = data["X_validation_gru"]
    X_test_gru = data["X_test_gru"]
    ...
    def objective(trial):
        ...
        try:
            ...
            model.fit(
                ...
                validation_data=(X_validation_gru, y_validation),
                verbose=0,
    ...
    data_usage_info = {
        ...
        "gru_input_shape": list(input_shape),
        "actual_epochs": actual_epochs,
        "run_time_seconds": run_time,
...
def main():
    ...
    summary_csv_path = SAVE_ROOT / "cluster_gru.csv"
