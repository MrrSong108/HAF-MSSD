...
def prepare_train_validation_test(train_df, validation_df, test_df):
    ...
    # CNN input format used by the original cluster CNN script:
    ...
    X_validation_cnn = X_validation.reshape(X_validation.shape[0], 1, X_validation.shape[1])
    ...
    return {
        ...
        "X_validation_cnn": X_validation_cnn,
...
def train_one_cluster(class_name, train_path, validation_path, test_path):
    ...
    X_validation_cnn = data["X_validation_cnn"]
...
def main():
    ...
    summary_csv_path = SAVE_ROOT / "cluster_cnn.csv"
