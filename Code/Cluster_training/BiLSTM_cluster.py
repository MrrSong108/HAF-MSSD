...
def prepare_train_validation_test(train_df, validation_df, test_df):
    ...
    X_validation_bilstm = X_validation.reshape(X_validation.shape[0], 1, X_validation.shape[1])
    ...
    return {
        ...
        "scaler_X": scaler_X,
        "scaler_y": scaler_y,
        "X_train_bilstm": X_train_bilstm,
        "X_validation_bilstm": X_validation_bilstm,
        "X_test_bilstm": X_test_bilstm,
        "y_train": y_train,
...
def train_one_cluster(class_name, train_path, validation_path, test_path):
    ...
    split_info_save_path = cluster_save_dir / "data_usage_info.json"
    ...
    X_train_bilstm = data["X_train_bilstm"]
    X_validation_bilstm = data["X_validation_bilstm"]
    X_test_bilstm = data["X_test_bilstm"]
    ...
    def objective(trial):
        ...
        try:
            ...
            model.fit(
                ...
                validation_data=(X_validation_bilstm, y_validation),
                verbose=0,
...
def main():
    ...
    summary_csv_path = SAVE_ROOT / "cluster_bilstm.csv"
