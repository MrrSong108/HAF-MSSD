...
OUTPUT_DIR = Path(os.getenv("OUTPUT_DIR", "outputs/tcfm_euclidean_rf_optuna"))
...
def optimize_rf_for_cluster(
    ...
    """
    Optimize Random Forest hyperparameters within a single cluster.
...
# =========================================================
# 13. Train cluster-specific Random Forest models
# =========================================================
print("\nTraining cluster-specific Random Forest models...")
...
print("Training the global fallback Random Forest model...")
...
for cluster_id in range(best_k):
        ...
        cluster_optuna_records.append(
            {
                ...
                "best_rmse": None,
                "best_params": json.dumps(BASE_RF_PARAMS, ensure_ascii=True),
            }
        )
    ...
    if n_valid_cluster == 0:
        print(
            ...
            "The base Random Forest parameters will be used."
        )
...
def predict_by_cluster_models(X, cluster_labels, cluster_models):
    """
    Predict each sample using the Random Forest model corresponding to its assigned cluster.
    """
...
# =========================================================
print("\nRunning TCFM-RF fusion prediction...")
